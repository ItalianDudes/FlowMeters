...
public class ComputerComponentEnergyMeter implements IPeripheral {
  public static final String COMPONENT_NAME = "energy_meter";

  private final TileEntityEnergyMeterBase meter;

  public ComputerComponentEnergyMeter(TileEntityEnergyMeterBase meter) {
    this.meter = meter;
  }
  ...
  public boolean equals(@Nullable IPeripheral other) {
    ...
    if (other instanceof ComputerComponentEnergyMeter) {
      ComputerComponentEnergyMeter otherComponent = (ComputerComponentEnergyMeter) other;
