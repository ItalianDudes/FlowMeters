...
import it.italiandudes.flowmeters.energy.storage.MJStorage;
import it.italiandudes.flowmeters.integration.BuildcraftIntegration;
...
public class TileEntityEnergyMeterMJ extends TileEntityEnergyMeterBase {
  ...
  public long getRequestedEnergy(EnumFacing side) {
    ...
    if (this.outputSide != null) {
      ...
      IMjReceiver outputReciever =
          BuildcraftIntegration.getMJReceiver(
  ...
  protected void checkConnections() {
    ...
    if (this.inputSide != null && this.outputSide != null && this.inputMJStorage != null && this.outputMJStorage != null) {
      ...
      IMjReceiver outputReciever = BuildcraftIntegration.getMJReceiver(this.world, outputNeightbor, this.outputSide.getOpposite());
