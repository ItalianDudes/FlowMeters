...
import it.italiandudes.flowmeters.integration.ComputerComponentEnergyMeter;
import it.italiandudes.flowmeters.integration.ModIDs;
import it.italiandudes.flowmeters.network.BufferUtil;
import it.italiandudes.flowmeters.network.PacketEnergyTransferRate;
...
public abstract class TileEntityEnergyMeterBase extends TileEntity implements ITickable,
  ...
  private final ComputerComponentEnergyMeter computerComponentEnergyMeter;

  public TileEntityEnergyMeterBase(EnergyType energyType) {
    this.energyType = energyType;
    this.energyAlias = energyType.getDefaultAlias();
    this.computerComponentEnergyMeter = new ComputerComponentEnergyMeter(this);
  }

  @Nullable
  public ComputerComponentEnergyMeter getComputerComponent() {
    return this.computerComponentEnergyMeter;
  }
  ...
  public void setEnergyAlias(EnergyAlias alias) {
    if (alias.getEnergyType() != this.energyType) {
      FlowMeters.LOGGER.error("Tried to set alias of type {} to meter of type {}",
  ...
  public String getComponentName() {
    return ComputerComponentEnergyMeter.COMPONENT_NAME;
  }
  ...
  public Object[] getTransferRate(final Context context, final Arguments args) {
    return this.computerComponentEnergyMeter.getTransferRate();
  }

  @Optional.Method(modid = ModIDs.OPENCOMPUTERS)
  @Callback(doc = "function():number -- gets the total energy transferred though this meter")
  public Object[] getTotalEnergyTransferred(final Context context, final Arguments args) {
    return this.computerComponentEnergyMeter.getTotalEnergyTransferred();
  }
  ...
  public Object[] getStatus(final Context context, final Arguments args) {
    return this.computerComponentEnergyMeter.getStatus();
  }
  ...
  public Object[] getRedstoneControlState(final Context context, final Arguments args) {
    return this.computerComponentEnergyMeter.getRedstoneControlState();
  }
  ...
  public Object[] getEnergyType(final Context context, final Arguments args) {
    return this.computerComponentEnergyMeter.getEnergyType();
  }

  @Optional.Method(modid = ModIDs.OPENCOMPUTERS)
  @Callback(doc = "function():string -- returns the current energy type alias, such as \"RF\"")
  public Object[] getEnergyTypeAlias(final Context context, final Arguments args) {
    return this.computerComponentEnergyMeter.getEnergyTypeAlias();
  }
  ...
  public Object[] getTransferRateLimit(final Context context, final Arguments args) {
    return this.computerComponentEnergyMeter.getTransferRateLimit();
  }
  ...
  public Object[] setTransferRateLimit(final Context context, final Arguments args) {
    return this.computerComponentEnergyMeter.setTransferRateLimit(args.checkInteger(0)) ;
  }
