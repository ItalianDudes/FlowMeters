...
public class FluidMeterScreenRenderer extends TileEntitySpecialRenderer<TileEntityFluidMeterBase> {
  ...
  @Override
  public void render(@NotNull TileEntityFluidMeterBase tile, double x, double y, double z, float partialTicks,
    ...
    if (tile.isDisabled()) {
      ...
      String displayText = formatRate(tile.getTransferRate() / (float) tile.getFluidScale());
      ...
      fontRenderer.drawString(TextFormatting.WHITE + "mB/t", (SCREEN_SIZE - 22) / 2, 25, WHITE);
    }
