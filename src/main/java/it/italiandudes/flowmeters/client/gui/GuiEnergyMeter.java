...
import it.italiandudes.flowmeters.client.model.EnergyMeterTextureLocations;
import it.italiandudes.flowmeters.energy.EnergyType.EnergyAlias;
import it.italiandudes.flowmeters.network.PacketUpdateEnergyMeterConfig;
...
public class GuiEnergyMeter extends GuiScreen {
  private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(
      FlowMeters.MODID, "textures/gui/energymeter.png");
  ...
  public GuiEnergyMeter(TileEntityEnergyMeterBase tile) {
    ...
    this.sideTexture = EnergyMeterTextureLocations.getGuiResource(EnergyMeterTextureLocations.getSideTexture(type));
    this.inputTexture = EnergyMeterTextureLocations.getGuiResource(EnergyMeterTextureLocations.getInputTexture(type));
    this.outputTexture = EnergyMeterTextureLocations.getGuiResource(EnergyMeterTextureLocations.getOutputTexture(type));
    this.screenTexture = EnergyMeterTextureLocations.getGuiResource(EnergyMeterTextureLocations.getScreenTexture(type));
  }
  ...
  protected void actionPerformed(@NotNull GuiButton button) throws IOException {
    ...
    if (sendUpdatePacket) {
      FlowMeters.NETWORK.sendToServer(
          new PacketUpdateEnergyMeterConfig(
            this.tile.getPos(),
